...
description: 'The default behavioral standards and enforcement ladder for every repository on this account.'
tags: [code-of-conduct, community, enforcement]
category: community
-->
...
**A harassment-free experience for everyone, enforced consistently.**

_Assume good faith. Act in good faith._
...
> [!NOTE]
> This is the **default code of conduct** for repositories owned by
> [@tannergolden](https://github.com/tannergolden). It applies to any repository that does not
> publish its own `CODE_OF_CONDUCT.md`. Where a repository ships its own, that one wins.
...
> commits, code, wiki edits, issues, and other contributions that are not aligned to this Code of Conduct, and will
...
officially representing the community in public spaces. This includes:
...
Report abusive, harassing, or otherwise unacceptable behavior to the project maintainers by
contacting [@tannergolden](https://github.com/tannergolden) directly through GitHub.
...
For behavior that violates
[GitHub's Terms of Service](https://docs.github.com/site-policy/github-terms/github-terms-of-service),
you can also
[report content directly to GitHub](https://docs.github.com/communities/maintaining-your-safety-on-github/reporting-abuse-or-spam).
...
**A community worth contributing to.**
