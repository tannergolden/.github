<!--
title: '🙋 SUPPORT'
description: 'The default support guide routing questions, bugs, and reports to the channel that answers them fastest.'
tags: [support, community, issue-routing]
category: community
-->
...
> [!NOTE]
> This is the **default support guide** for repositories owned by
> [@tannergolden](https://github.com/tannergolden). It applies to any repository that does not
> publish its own `SUPPORT.md`. Where a repository ships its own guide, that guide wins.
...
Most questions are answered faster by the repository itself than by waiting for a reply:
